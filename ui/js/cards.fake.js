...
cards.fake = (function() {
  ...
  getTagList = function() {
    return [
      { name: 'HTML', id: 'tag_01' },
      { name: 'CSS', id: 'tag_02' },
      { name: 'JavaScript', id: 'tag_03' },
      { name: 'Ruby', id: 'tag_04' },
      { name: 'Rails', id: 'tag_05' },
      { name: 'Star Wars', id: 'tag_06' }
    ];
  };

  getNoteList = function() {
    return [
      { name: 'Rails環境構築手順', id: 'note_01', cards: [] },
      { name: 'Rails cheat sheet', id: 'note_02', cards: [] },
      { name: 'サーバ設定ログ', id: 'note_03', cards: [] },
      {
        name: 'Star Wars Opening', id: 'note_04',
        cards: [
